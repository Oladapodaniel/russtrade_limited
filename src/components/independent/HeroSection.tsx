import { hero_img, hero_img_bg, hero_success_card } from "@/constants/image";
        ...
        <div className="container mx-auto py-10 ">
            <div className="grid grid-cols-2 gap-4 items-center">
                ...
                {/* <motion.div
                    ...
                    transition={{ duration: 1 }}
                    className="p-4 col-span-3 md:col-span-2"
                >
                    <div className="satoshi-black text-4xl md:text-6xl text-header-text">Russtrade Business <br />Consulting</div>
                    <div className="mt-6 text-header">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil vitae corrupti eum cum veritatis <br />nam officia nostrum fugi dio numquam unde voluptates, quia eveniet eius cumque <br />et aliquam quae debitis?</div>
                    <div className='mt-10 flex justify-center sm:justify-start w-full'>
                        <FilledButton />
                    </div>
                </motion.div> */}
                ...
                {/* <motion.div
                    ...
                    transition={{ duration: 1, delay: 0.5 }}
                    className="p-4 py-10 relative col-span-3 md:col-span-1"
                >
                    <img src={hero_img_bg} alt="hero-image_background" className="absolute left-8" />
                    <img src={hero_success_card} alt="hero_image_success_card" className="absolute bottom-0 -left-10" />
                    <img src={hero_img} alt="hero_image" />
                </motion.div> */}
                {/* <div className="p-4 py-10 relative col-span-3 md:col-span-1">
                    <img src={hero_img_bg} alt="hero-image_background" className="absolute left-8" />
                    <img src={hero_success_card} alt="hero_image_success_card" className="absolute bottom-0 -left-10" />
                    <img src={hero_img} alt="hero_image" />
                </div> */}
